...
readonly BIN="$WORK/harmony-staking-target-audit-amd64-v2"
readonly CSV="$WORK/staking-targets-post2023-to-oct2024-v2.csv"
readonly SUMMARY="$WORK/staking-targets-post2023-to-oct2024-v2-summary.json"

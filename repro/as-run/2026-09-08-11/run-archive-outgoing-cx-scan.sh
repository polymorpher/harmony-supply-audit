...
readonly BIN="$WORK/harmony-outgoing-cx-scan-amd64"
readonly EXPECTED_BIN_SHA256=${EXPECTED_BIN_SHA256:?set EXPECTED_BIN_SHA256}
readonly OUTPUT="$WORK/shard0-canonical-outgoing-receipts.csv"
readonly LOG="$WORK/shard0-canonical-outgoing-receipts-summary.log"
